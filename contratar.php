...
if (isset($_POST['submit'])) { // se o botao de envio for clicado 
  ...
  // se
  if ($publi === "" and $_FILES['fotopubli1'] == 0 and
       $_FILES['fotopubli2'] == 0 and $_FILES['fotopubli3']
       == 0 and $_FILES['fotopubli4'] == 0) {
    return;
  } 
    ...
    //retorna o numero de linhasb
    $return = mysqli_num_rows($validar);
    unset($sql);

// para nao repetir publicacao
...
<main class='main'>
  ...
  <div class='cardform'>
    <form method='post' action='contratar.php' enctype='multipart/form-data'>
      ...
      <div class='containerpubli'>
        <div class='fotopubli'>
          ...
          <label class='labelfoto' onclick="imgReact('fotopubli1', 'span1', 'fotoLabel')">
            ...
            <input type='file' accepts='image/*' name='fotopubli1' id='fotopubli1' class='hidden'>
          </label>
          ...
          <label class='labelfoto' onclick="imgReact('fotopubli2', 'span2', 'fotoLabel')">
            ...
            <input type='file' accepts='image/*' name='fotopubli2' id='fotopubli2' class='hidden'>
          </label>


          <label class='labelfoto' onclick="imgReact('fotopubli3', 'span3', 'fotoLabel')">
            <span class='spanfoto' id='span3'><i class="fa-solid fa-image"></i></i></span>
            <input type='file' accepts='image/*' name='fotopubli3' id='fotopubli3' class='hidden'>
          </label>


          <label class='labelfoto' onclick="imgReact('fotopubli4', 'span4', 'fotoLabel')">
            <span class='spanfoto' id='span4'><i class="fa-solid fa-image"></i></i></span>
            <input type='file' accepts='image/*' name='fotopubli4' id='fotopubli4' class='hidden'>
          </label>
        </div>

        <div class='divbtn'>
          <button type='submit' id='submit' name='submit' class='btn' style='scale: 0.9;' onclick='submitForm()'>Publicar
          </button>
  ...
  <div>
    ...
    $id = $_SESSION['usuario']['cod_usuario'];
    //CRIA O SELECT
    $consulta = "SELECT * FROM tb_publi where cod_cat = 1 order by cod_publi desc";
